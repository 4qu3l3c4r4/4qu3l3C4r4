...
public class Pdf {
	private static String FILE=Constants.PDF_PATH;
	Document document;
	...
	public Pdf(ArrayList prints) {
		try {
			DateFormat dateFormat = new SimpleDateFormat("yy-MM-dd HH-mm-ss");
			Date date = new Date();
			document = new Document(PageSize.A4_LANDSCAPE);
			PdfWriter.getInstance(document, new FileOutputStream(FILE+ dateFormat.format(date)+".pdf"));
			document.open();
